...
- **One-good economy**: There is a single consumption good whose price falls with productivity, so the purchasing-power multiples should be read as applying to the AGI-producible bundle. In reality AI deflates compute, manufactured goods, and many services, but land, housing, and other positional or supply-constrained goods do not get cheaper with productivity — and housing is the largest budget item for low-income households. Real-world purchasing-power gains at the bottom would be muted exactly where they matter most, which flattens (but does not reverse) the contrast between the competitive and monopoly scenarios.
